...
public static void main(String[] args) {
	...
	s1.getOcenki().put("Ikonomika", new ArrayList<>(Arrays.asList(5,6,6)));
	s1.getOcenki().put("Biologiq", new ArrayList<>(Arrays.asList(3,3,3)));
	s1.getOcenki().put("Matematika", new ArrayList<>(Arrays.asList(2,5,4)));
	...
	s2.getOcenki().put("Georgrafiq", new ArrayList<>(Arrays.asList(4,4,4)));
	s2.getOcenki().put("Ikonomika", new ArrayList<>(Arrays.asList(5,5,4)));
	s2.getOcenki().put("BG", new ArrayList<>(Arrays.asList(3,3,5)));
	
	Student s3 = new Student();
	s3.getOcenki().put("Sport",new ArrayList<>(Arrays.asList(4,3,3)));
	s3.getOcenki().put("Geografiq", new ArrayList<>(Arrays.asList(5,4,5)));
	s3.getOcenki().put("Istoriq", new ArrayList<>(Arrays.asList(6,4,6)));
	s3.getOcenki().put("Biologiq", new ArrayList<>(Arrays.asList(6,6,6)));
	s3.getOcenki().put("Matematika", new ArrayList<>(Arrays.asList(6,4,6)));
